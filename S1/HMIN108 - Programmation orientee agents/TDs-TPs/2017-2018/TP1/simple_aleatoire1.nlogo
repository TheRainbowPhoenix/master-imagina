...
to setup
  ...
  set-default-shape turtles "ghost"
  

  
  set-default-shape queens "bee 2"
  ...
  create-queens reines [
    set color red
    setxy random-xcor random-ycor
    set size 5
  ]
  
  create-bees abeilles [
    set color yellow
    setxy random-xcor random-ycor
    set size 4
  ]
...
to abeilles-reine
  let following one-of queens in-radius perception
  if (following != nobody) [face following]
   fd 10
     
end

to go
 ask queens [reines-move]
 ask bees [abeilles-reine]
 tick
end
