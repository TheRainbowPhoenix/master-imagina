...
/**
 * Represents a generic Constraint (abstract). Should be specialized
 * for each kind of constraint by defining :
 * a specific constructor, a constructor to create a constraint from a string,
 * a method to test for violations,
 * a toString method.
 */
...
public abstract class Constraint {
     ...
     *
     * @return la liste des variables contraintes
     */
