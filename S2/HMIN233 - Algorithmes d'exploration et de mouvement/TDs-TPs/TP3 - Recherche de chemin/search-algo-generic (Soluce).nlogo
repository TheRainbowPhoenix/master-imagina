...
to create-agents
  ...
  create-turtles number-turtles [
    ...
    if (trace = true) [show (sentence "current node : " current "current goal " mygoal)]
  ]
end
...
;; crée une liste avec le min des couts...
